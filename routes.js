...
module.exports = function (app, passport, roles, mongoose, io, isLoggedIn) {
    ...
    //     res.redirect('/landing');
    // }
    // require('./controllers/proyectos.js')(app, passport, roles, mongoose, io);
    // require('./controllers/historiasUsuarios.js')(app, passport, roles, mongoose, io);
    // require('./controllers/liberacionesBacklogs.js')(app, passport, roles, mongoose, io, isLoggedIn);
    // require('./controllers/sprints.js')(app, passport, roles, mongoose, io);
    // require('./controllers/usuarios.js')(app, passport, roles, mongoose, io);
    //
